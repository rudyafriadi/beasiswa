      ...
      <div class="col-12 col-sm-6 col-md-6">
        <div class="info-box mb-6">
          ...
          <div class="info-box-content">
            <span class="info-box-text">Jumlah Penerima Beasiswa</span>
        ...
        <!-- /.info-box -->
          ...
          <div class="col-12 col-sm-6 col-md-6">
              <div class="info-box mb-6">
                ...
                <div class="info-box-content">
                  <span class="info-box-text">Jumlah Berkas Masuk</span>
                  <span class="info-box-number">200
                    <small>Dokumen</small>
                  </span>
                </div>
                <!-- /.info-box-content -->
      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header">
            <h5 class="card-title">Grafik Jumlah Penerima Beasiswa</h5>
